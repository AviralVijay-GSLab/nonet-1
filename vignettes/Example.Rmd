...
```
```{r}
#banknote_authentication <- read.csv("C:/Users/gs-1854/Documents/GitHub/nonet/data/data_banknote_authentication.csv")

```

```{r}
#save(banknote_authentication, file="C:/Users/gs-1854/Documents/GitHub/nonet/data/banknote_authentication.rda")
```


```{r}
#names(read_file) = c("variance", "skewness", "curtosis", "entropy", "class")
#read_file
```
