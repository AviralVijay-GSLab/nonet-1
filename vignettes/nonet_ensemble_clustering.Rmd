...
```{r, warning = FALSE}
plot_second <- nonet_plot(Prediction_dataframe$pred_clust_first, Prediction_dataframe$pred_nonet, Prediction_dataframe, plot_type = "hist")
plot_second
```
```{r, warning = FALSE}
plot_third <- nonet_plot(Prediction_dataframe$pred_clust_second, Prediction_dataframe$pred_nonet, Prediction_dataframe, plot_type = "hist")
plot_third
```
